  ...
  const itemsHTML = (order.items || [])
    .map(
      ...
      <tr style="border-bottom: 1px solid #E5E7EB;">
        ...
        <td style="padding: 14px; text-align: center;">${item.quantity || 1}</td>
        <td style="padding: 14px; text-align: right;">₹${Number(item.price || 0).toLocaleString()}</td>
        <td style="padding: 14px; text-align: right; font-weight: 700; color: #2e0e43;">₹${(
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .badge { font-size: 14px; text-transform: uppercase; letter-spacing: 0.2em; color: #C8A97A; font-weight: bold; margin-top: 4px; }
          ...
          .card h4 { margin: 0 0 8px 0; text-transform: uppercase; font-size: 14px; letter-spacing: 0.15em; color: #7B6D63; }
          .card p { margin: 3px 0; font-size: 14px; color: #2A2623; }
          table { width: 100%; border-collapse: collapse; margin-bottom: 30px; }
          th { background: #2e0e43; color: white; text-transform: uppercase; font-size: 14px; letter-spacing: 0.15em; padding: 14px 14px; text-align: left; }
          th.right { text-align: right; }
          th.center { text-align: center; }
          .totals { margin-left: auto; width: 320px; font-size: 14px; }
          .row { display: flex; justify-content: space-between; padding: 6px 0; }
          .grand-total { font-size: 16px; font-weight: bold; color: #2e0e43; border-top: 2px solid #2e0e43; padding-top: 14px; margin-top: 14px; }
          .footer { margin-top: 50px; text-align: center; font-size: 14px; color: #7B6D63; border-top: 1px solid #E5E7EB; padding-top: 15px; }
        </style>
      </head>
      <body>
        <div class="header">
          ...
          <div style="text-align: right;">
            ...
            <div style="font-size: 14px; color: #7B6D63; margin-top: 4px;">Date: ${orderDate}</div>
          </div>
        </div>
