...
const About = () => {
  ...
  return (
    <div className="overflow-hidden font-serif" style={{ backgroundColor: CREAM, color: DARK, fontFamily: SERIF }}>
        ...
        <div className="max-w-[1320px] mx-auto">
          ...
          <div className="max-w-3xl mb-14 lg:mb-20 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-base lg:text-[18px] tracking-[0.3em] font-medium text-[#7B6D63] uppercase" style={{ fontFamily: SERIF }}>
            ...
            >
              ...
              <span className="italic" style={{ color: CRIMSON, fontFamily: SERIF }}>into a Global Journey.</span>
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <div className="border-l border-[#D8CBBE] pl-6 space-y-3 hidden lg:block">
                <span className="text-[17px] tracking-widest font-semibold uppercase text-[#7B6D63]" style={{ fontFamily: SERIF }}>Our Essence</span>
                <p className="text-[19px] font-light leading-relaxed italic text-[#5C534C]" style={{ fontFamily: SERIF }}>
            ...
            <div className="lg:col-span-7 flex flex-col space-y-8 text-[#5C534C] text-[18px] lg:text-[20px] leading-relaxed font-light" style={{ fontFamily: SERIF }}>
              ...
              <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.05 }}>
              ...
              <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.1 }}>
              ...
              <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.15 }}>
              ...
              <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.2 }}>
              ...
              <div className="pt-6 space-y-6">
                ...
                <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.25 }}>
                ...
                <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.3 }}>
                  We believe the most beautiful pieces are not simply worn   they are discovered, collected, remembered, and made your own.
                </motion.p>

                <motion.p style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.35 }}>
                ...
                <motion.div
                  ...
                  style={{ borderColor: CRIMSON, fontFamily: SERIF }}
                  {...fadeUp}
                  transition={{ delay: 0.4 }}
                >
                  <p className="text-[19px] lg:text-[21px] font-medium text-[#2A2623]" style={{ fontFamily: SERIF }}>
                    For Zahabiya and Alifiya , VELOURAZ is more than a brand.
                  </p>
                  <ul className="space-y-2 text-lg text-[#5C534C]" style={{ fontFamily: SERIF }}>
                    <li style={{ fontFamily: SERIF }}>It is a friendship transformed into a journey.</li>
                    <li style={{ fontFamily: SERIF }}>A curiosity transformed into a collection.</li>
                    <li style={{ fontFamily: SERIF }}>And a dream transformed into something you can wear.</li>
                  </ul>
                </motion.div>

                <motion.div className="space-y-2 pt-2" {...fadeUp} transition={{ delay: 0.45 }}>
                  <p className="italic text-[19px] lg:text-[21px] text-[#2e0e43]" style={{ fontFamily: SERIF }}>
      ...
      <section className="px-6 py-20 lg:py-32 border-t border-[#D8CBBE]/30" style={{ backgroundColor: '#FDFCF7' }}>
        <div className="max-w-[1320px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-7 space-y-8" style={{ fontFamily: SERIF }}>
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="italic" style={{ color: CRIMSON, fontFamily: SERIF }}>part of your journey.</span>
                </h2>
              </div>

              <div className="text-[18px] lg:text-[19px] text-[#5C534C] leading-relaxed font-light space-y-6" style={{ fontFamily: SERIF }}>
                ...
                <motion.ul className="space-y-2 pt-1 border-l-2 border-[#C8A97A]/40 pl-6" style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.05 }}>
                  <li className="text-[18px] sm:text-[19px] text-[#2A2623] italic" style={{ fontFamily: SERIF }}>For the woman who dresses for herself.</li>
                  <li className="text-[18px] sm:text-[19px] text-[#2A2623] italic" style={{ fontFamily: SERIF }}>For the woman who finds beauty in the everyday.</li>
                  <li className="text-[18px] sm:text-[19px] text-[#2A2623] italic" style={{ fontFamily: SERIF }}>For the woman who carries memories from places she has been   and dreams of places yet to discover.</li>
                </motion.ul>
                ...
                <motion.div className="space-y-2 pt-4 border-t border-[#D8CBBE]/30" style={{ fontFamily: SERIF }} {...fadeUp} transition={{ delay: 0.3 }}>
                  <p className="text-[21px] lg:text-[23px] font-medium text-[#2A2623]" style={{ fontFamily: SERIF }}>
                    From our hands, into your story.
                  </p>
                  <p className="text-[19px] lg:text-[21px] italic text-[#2e0e43]" style={{ fontFamily: SERIF }}>
        ...
        <div className="max-w-[1320px] mx-auto px-6 py-14 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <motion.div className="lg:col-span-8 space-y-4" {...fadeUp}>
              <span className="text-[17px] tracking-[0.25em] uppercase font-semibold text-[#7B6D63]" style={{ fontFamily: SERIF }}>
                With Love,
              </span>
              <p
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[17px] tracking-[0.2em] uppercase font-semibold text-[#2A2623]" style={{ fontFamily: SERIF }}>
                  Founders, VELOURAZ
                </span>
              </div>
            </motion.div>
